        ...
        {cells.map((day, idx) => (
          <div
            ...
            className={cn(
              ...
              day !== null && !isToday(day) && !isSelected(day) && isCurrentMonth(day) && "cursor-pointer text-foreground hover:bg-muted/50",
              day !== null && !isCurrentMonth(day) && "text-muted-foreground/25",
            )}
          >
            {day ?? ""}
